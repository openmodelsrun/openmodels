...
### Added
- **Kimi K3 on OpenRouter** — added an OpenRouter mapping for `kimi-k3` at $3 / $15 per 1M tokens (matches the Moonshot list price).
...
### Added
- **Kimi K3** (Moonshot AI, China) — Moonshot's flagship model for agentic coding, knowledge work, and deep reasoning, with a 1M-token context window.
- **Inkling** (Thinking Machines Lab, US) — open-weights 975B-parameter MoE model (41B active) with 1M context and text, image, and audio input for agentic systems, coding assistants, chatbots, and RAG.

### Changed
- Total coverage: 127 models · 51 providers · 196 mappings
